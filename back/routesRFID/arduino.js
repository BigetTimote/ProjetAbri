...
const ARDUINO_CONFIG = {
    host: '172.29.18.201', // IP de l'Arduino (à adapter)
    port: 8080,
    timeout: 5000
};

/**
 * Fonction pour envoyer une notification à l'Arduino
...
/**
 * Route pour vérifier la connexion avec l'Arduino
 */
...
// Export de la fonction pour l'utiliser dans d'autres routes
